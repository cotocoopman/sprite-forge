...
export type Accessory = {
  ...
  // Anclar a OTRO accesorio (en vez de un hueso del esqueleto): su id + qué parte.
  readonly anchorTo?: { readonly id: string; readonly part: AnchorPart };
};

export type AnchorPart = 'base' | 'tip' | 'center';
